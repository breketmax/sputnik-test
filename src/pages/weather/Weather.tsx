...
const Weather:React.FC = () => {
    const {name,lat,lon,isFullfield} = useAppSelector(state => state.rootReducer.cityReducer);
    const {main,isWeatherFullfield} = useAppSelector(state => state.rootReducer.weatherReducer)
    ...
    return (
        <div className='weather-page'>
            weather-page
            <Input placeholder='Enter the city name' onChange={cityHandler} value={name}/>
